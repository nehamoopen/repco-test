...
author: 'Utrecht University: Research Data Management (RDM) Support & Open Science
  Community Utrecht (OSCU)'
date: "`r Sys.Date()`"
...
link-citations: yes
description: This is a digital book for the course on _Best Practices for Writing
  Reproducible Code_. It contains all the relevant materials required for the course.
---
