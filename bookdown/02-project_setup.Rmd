# Project setup & version control with git {#project-setup}
...
Project setup slides for reference :
...
```{r}
knitr::include_url('https://utrechtuniversity.github.io/workshop-computational-reproducibility/slides/slides_project-setup.html#1')
```
...
```{r}
knitr::include_url('https://vimeo.com/462773031')
```
